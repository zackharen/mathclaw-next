...
export function serializeQuestionKindReviewQuestion(question) {
  return {
    prompt: question.prompt,
    answer: question.answer,
    choices: question.choices,
    choiceLabels: question.choices.map((choice) => question.formatChoice(choice)),
    explanation: question.explanation,
  };
}

export function hydrateQuestionKindReviewQuestion(question) {
  return {
    ...question,
    formatChoice(choice) {
      const choiceIndex = question.choices.findIndex((candidate) => candidate === choice);
      return question.choiceLabels[choiceIndex] || choice;
    },
    checkAnswer(choice) {
