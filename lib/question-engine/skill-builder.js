...
export function serializeSkillBuilderQuestion(question) {
  return serializeSpiralReviewQuestion({
    ...question,
    skill: question.skill || (question.kind === "comparison" ? "comparison" : "integers"),
  });
}

export function hydrateSkillBuilderQuestion(question) {
  return hydrateSpiralReviewQuestion(question);
}
