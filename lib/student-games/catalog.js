...
export const GAME_CATALOG = [
  ...
  {
    slug: "locker_practice",
    name: "Locker Practice",
    category: "survival_skills",
    description: "Practice turning a real-style combination lock dial left and right until the locker pops open.",
    is_multiplayer: false,
  },
  {
    ...
    category: "math_skills",
    description: "Study a graphed line, then identify its slope and y-intercept.",
    is_multiplayer: false,
  },
  {
    slug: "sudoku",
  ...
  {
    slug: "double_board_review",
    name: "Double Board",
    category: "math_skills",
    description: "Run paired review boards where missed squares gain value and solved twins can inspire the other side.",
    is_multiplayer: false,
  },
  {
    slug: "open_middle",
    name: "Open Middle",
    category: "math_skills",
    description: "Launch reusable digit puzzles where students fill blanks, defend strategies, and compare multiple true solutions.",
    is_multiplayer: false,
  },
  {
    slug: "skill_builder",
  ...
  {
    slug: "lowest_number_wins",
    name: "Lowest Number Wins",
    category: "math_skills",
    description: "Everyone picks a number. Whoever picks the lowest number that no one else picked wins the round.",
    is_multiplayer: true,
  },
  {
