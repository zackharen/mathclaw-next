...
export function deterministicTournamentGameId(tournamentMatchId, sourceMatchId = "initial") {
  const hash = createHash("sha256")
    .update(`mathclaw-connect4-tournament:${tournamentMatchId}:${sourceMatchId}`)
    .digest("hex")
    .slice(0, 32)
    .split("");
  hash[12] = "5";
