...
import { eligibleVocabulary, shuffledVocabulary, VOCABULARY_CAROUSEL_TYPE } from "@/lib/projector/vocabulary-carousel.mjs";
...
async function vocabularyForCourse(admin, teacherId, courseId) {
...
export async function POST(request) {
  ...
  try {
    ...
    for (const screenId of selected) {
      ...
      const words = shuffledVocabulary(eligible, crypto.randomInt).map((entry) => ({
        id: entry.id,
        word: entry.title,
