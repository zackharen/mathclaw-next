...
export default async function QuestionKindReviewPage({ searchParams }) {
  ...
  if (initialCourseId) {
    const { data: leaderboardRows } = await supabase.rpc("list_course_game_leaderboard", {
      ...
      p_game_slug: "question_kind_review",
    });
